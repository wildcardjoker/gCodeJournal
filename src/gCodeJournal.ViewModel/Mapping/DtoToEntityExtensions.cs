...
public static class DtoToEntityExtensions
{
 ...
 public static ModelDesign ToEntity(this ModelDesignDto dto) => new() { Id = dto.Id, Description = dto.Description, Length = dto.Length, Summary = dto.Summary, Url = dto.Url };
